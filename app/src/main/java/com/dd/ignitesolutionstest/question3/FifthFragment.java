...
public class FifthFragment extends Fragment {
     ...
     * @return A new instance of fragment FragmentFith.
     */
    ...
    public void onAttach(@NonNull Context context) {
        ...
        String message = ((FragmentExampleActivity) getActivity()).attachSequence;
        message = message + FifthFragment.class.getName() + " Attached \n";
        ((FragmentExampleActivity) getActivity()).attachSequence = message;
    }
}